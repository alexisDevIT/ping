...
<div class="container-fluid my-5 pt-5">    
    <form id="searchIP" class="mt-5">
        ...
        <div class="ps-3 d-flex align-items-center justify-content-between"><i class="text-danger cerrar bi" role="button" onclick="document.querySelector('#itemsResultados').removeAttribute('style', 'display:none');"></i><strong class="statuSearch poppins-bold small p-3"></strong></div>
    </form>
