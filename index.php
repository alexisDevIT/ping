    ...
    <div class="container-fluid">
        <div class="d-flex flex-wrap align-items-center justify-content-between justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto ms-lg-auto mb-2 justify-content-center mb-md-0">  
                <li><a href="complements/paused_address.php" class="nav-link px-2 text-white font2" title="Enliste las direcciones que ha pausado..."><i class="bi bi-play-circle"></i> Pausadas</a></li>                
...
<div class="container-fluid my-5 pt-5">    
    <form id="searchIP" class="mt-5">
        ...
        <strong class="statuSearch poppins-bold small p-3"></strong>
    </form>
